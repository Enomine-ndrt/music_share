...
import UpdateArtist from './pages/UpdateArtist/UpdateArtist';
import PathUrl from './pages/PathUrl/StoragePath';
    ...
    <Router>
      <Provider store={Store}>
        <Routes>
          ...
          <Route exact path="/UpdateArtist" element={<UpdateArtist />} />
          <Route exact path="/PathUrl" element={<PathUrl />} />
        </Routes>
      </Provider>
    </Router>
  )
