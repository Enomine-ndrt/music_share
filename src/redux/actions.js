...
try{
    ...
    const API_URL = `http://192.168.1.132:8080/music_share/php-rest-api/api/cancion/single_read.php?id_artista=${id_artista}&id_album=${id_album}`;
...
export const getAllArtist = () =>{
    try{
        ...
        const API_URL = `http://192.168.1.132:8080/music_share/php-rest-api/api/artista/read.php`;
...
export const getAllAlbumsArtist = (id) =>{
    try{
        ...
        const API_URL = `http://192.168.1.132:8080/music_share/php-rest-api/api/album/single_read.php?id_artista=${id}`;
        const results = await axios.get(API_URL,config).then(async function (response) {
            console.log('respoinse ',response);
            return response;
        }).catch(function(error){
